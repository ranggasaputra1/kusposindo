...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <title>KUSPOSINDO | History Simpanan Sukarela</title>
  </head>
  <body id="page-top">
 ...
 <nav class="navbar navbar-expand-lg navbar-light  fixed-top " id="mainNav" style="background-color: #fafad2;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="simpanan_sukarela" style="color: black;"><button class="dropdown-item " type="button" >Sukarela</button></a>
            ...
            <li class="nav-item">
          <a class="nav-link active" href="jasa_usaha">Jasa Usaha</a>
        </li>
        <li class="nav-item">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="sukarela_history" style="color: black;"><button class="dropdown-item active" type="button" style="background-color:#e67e22">Simpanan Sukarela</button></a>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                                <h1 class="mt-4 container " style="text-align:left">Anggota | History Simpanan Sukarela</h1>
                                    <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>
                                 <div class="container text-container anggota">
                                    <button class="initombol">
                                        <a href="{{route('sukarela_history_cetak')}}" target="_blank" rel="noopener" target="_blank" style="color: black;"><i class="fas fa-print"></i> Cetak History</a>
                                    </button>
                               </div>
<br>
                            <!-- tabel  -->
                    ...
                    @foreach($sh as $ss)<tr style="text-transform: uppercase">
                    ...
                    <td style="text-align: center;">{{$ss->jumlah_sukarela}}</td>
                      ...
                      <td> <center>
                      <a href="sukarela_history/hapus/{{$ss->ID_simpanan_sukarela}}" type="button " class="btn btn-outline-danger btn-xs" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none;">
                    Hapus</i></a></center>
                        </td>
                    </tr>
                    @endforeach
