...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <title>KUSPOSINDO | Anggota</title>
  </head>
  <body id="page-top">
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                        <h1 class=" container mt-4 " style="text-align:left">Kusposindo | Anggota</h1>
                            <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>

                        <div class=" container text-container anggota"><a href="#"><button class="initombol" data-toggle="modal" data-target="#exampleModalLongTitle">Tambah Anggota</button></a></div>
                          <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title " id="exampleModalLongTitle">Tambah Data Anggota</h5>
            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    <div class="form-group has-warning"><label >ID Anggota</label>
                    <input type="number" class="form-control" name="ID_anggota" placeholder="Sudah diisi Otomatis" readonly>
                    </div>
                    
                    <div class="form-group has-warning"><label >Nama Anggota:</label>
                    <input type="text" class="form-control" name="nama_anggota" required>
                    </div>

                    <div class="form-group has-warning"><label >NIK</label>
                    <input type="number" class="form-control" name="NIK_anggota" required>
                    </div>

                    <div class="form-group has-warning">
                    <label for="exampleFormControlTextarea1">Alamat</label>
                    <textarea class="form-control" name="alamat_anggota" id="alamat_anggota" rows="4"></textarea>
                  </div>
                    
                    <div class="form-group has-warning"><label >No Telepon</label>
                    <input type="number" class="form-control" name="no_telp_anggota" required>
                    </div>
                    <div class="form-group has-warning"><label >Pendidikan Terakhir</label>
     ...
     @endif
                            ...
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    <tr style="text-transform: uppercase">
                                            <td scope="row" style="text-align: center;" style="text-transform: uppercase">{{$anggota->ID_anggota}}</td>
                                            <td  style="text-align: center;">{{$anggota->nama_anggota}}</td>
                                            <td  style="text-align: center;">{{$anggota->NIK_anggota}}</td>
                                            <td  style="text-align: center;">{{$anggota->alamat_anggota}}</td>
                                            <td  style="text-align: center;">{{$anggota->no_telp_anggota}}</td>
                                            <td  style="text-align: center;">{{$anggota->pendidikan_terakhir}}</td>

                                            <td> <center> <button type="button"  class="btn btn-outline-primary" data-toggle="modal" data-target="#ubahanggota{{$anggota->ID_anggota}}">Edit</button></center>

                                            

                                            
                         
        <div class="modal fade" id="ubahanggota{{$anggota->ID_anggota}}">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                @csrf
                <div class="form-group has-warning"><label >ID Anggota</label>
                    <input type="number" class="form-control" name="ID_anggota" value="{{$anggota->ID_anggota}}" readonly>
                    </div>
                    <div class="form-group has-warning"><label >Nama Anggota:</label>
                    ...
                    <div class="form-group has-warning"><label >NIK</label>
                    <input type="number" class="form-control" name="NIK_anggota" value="{{$anggota->NIK_anggota}}" required>
                    </div>

                    <div class="form-group has-warning">
                    <label>Alamat</label>
                    <textarea class="form-control" name="alamat_anggota" id="alamat_anggota" rows="4">{{$anggota->alamat_anggota}}</textarea>
                  </div>
                    
                    <div class="form-group has-warning"><label >No Telepon</label>
                    <input type="number" class="form-control" name="no_telp_anggota" value="{{$anggota->no_telp_anggota}}" required>
                    </div>
                    <div class="form-group has-warning"><label >Pendidikan Terakhir</label>
                    <input type="text" class="form-control" name="pendidikan_terakhir" value="{{$anggota->pendidikan_terakhir}}" required>
                    </div><br>
                    <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        ...
        <td> <center>
        <a href="anggota/hapus/{{$anggota->ID_anggota}}"  type="button" class="btn btn-outline-danger" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none;">Hapus</i></a></center>
    </td>                                    
    </tr>
                                        @endforeach
                                    </tbody> 
