...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <title>KUSPOSINDO | History Simpanan Wajib</title>
  </head>
  <body id="page-top">
 ...
 <nav class="navbar navbar-expand-lg navbar-light  fixed-top " id="mainNav" style="background-color: #fafad2;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="wajib_history" style="color: black;"><button class="dropdown-item active" type="button"  style="background-color:#e67e22">Simpanan Wajib</button></a>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                                <h1 class="mt-4 container " style="text-align:left">Anggota | History Simpanan Wajib</h1>
                                    <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>
                              <div class="container text-container anggota">
                                    <button class="initombol">
                                        <a href="{{route('wajib_history_cetak')}}" target="_blank" rel="noopener" target="_blank" style="color: black;"><i class="fas fa-print"></i> Cetak History</a>
                                    </button>
                               </div>
                ...
                <br>
                            <!-- tabel  -->
                                    ...
                                    <div class="card-header">
                                        ...
                                        DataTable History Simpanan Wajib | KUSPOSINDO
                                    </div>
                                    <div class="card-body">
