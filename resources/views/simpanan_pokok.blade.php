...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <title>KUSPOSINDO | Simpanan Pokok</title>
  </head>
  <body id="page-top">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <button class="dropdown-item active" type="button" style="background-color:#e67e22">Pokok</button></a>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                        <h1 class=" container mt-4 " style="text-align:left">Kusposindo | Simpanan Pokok</h1>
                            <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>

                        <div class=" container text-container anggota"><a href="#"><button class="initombol" data-toggle="modal" data-target="#exampleModalLongTitle">Tambah | Bayar</button></a></div>
                          <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title " id="exampleModalLongTitle">Tambah Data Anggota Simpanan Pokok</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                        <form method="post" action="simpanan_pokok/add">
                        {{ csrf_field() }}
                        <div class="form-group has-warning"><label >ID simpanan Pokok</label>
                            <input type="text" class="form-control" name="ID_simpanan_pokok" placeholder="Sudah diisi Otomatis" readonly>
                            </div>
                  ...
                  <select class="form-control" id="search_anggota" name="ID_anggota" data-width="100%">
                      ...
                      @endforeach
                            ...
                            <input type="date" class="form-control" name="tanggal_bayar_pokok" required>
                            </div>

                            <div class="form-group has-warning"><label >Nominal</label>
                            <input type="number" class="form-control" name="nominal_pokok" value="100.000" readonly>
                            </div>  
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
     ...
     @endif
                            ...
                            <!-- tabel  -->
                               <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        DataTable Simpanan Pokok | KUSPOSINDO
                                    </div>
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                        <thead>
                                        <tr style="text-transform: uppercase">
                                                    <th style="text-align: center;">ID Simpanan Pokok</th>
                                            ...
                                            <tbody>
                                            @foreach ($simpanan_pokokk  as $sw)
                                            <tr style="text-transform: uppercase">
                                                    <td style="text-align: center;">{{$sw->ID_simpanan_pokok}}</td>
                                                    <td style="text-align: center;">{{$sw->ID_anggota}}</td>
                                                    <td style="text-align: center;">{{$sw->tanggal_bayar_pokok}}</td>
                                                    <td style="text-align: center;">{{$sw->nominal_pokok}}</td>

                                                    <td><center> <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#ubahsimpanan_pokok{{$sw->ID_simpanan_pokok}}">
                                Edit</button></center>
                                <div class="modal fade" id="ubahsimpanan_pokok{{$sw->ID_simpanan_pokok}}">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <form method="post" action="simpanan_pokok/update">
                                        @csrf
                                        <div class="form-group has-warning"><label >ID simpanan pokok</label>
                            <input type="number" class="form-control" name="ID_simpanan_pokok" value="{{$sw->ID_simpanan_pokok}}" readonly>
                            </div>
                            ...
                            <div class="form-group has-warning"><label >Tanggal Bayar</label>
                            <input type="date" class="form-control" name="tanggal_bayar_pokok" value="{{$sw->tanggal_bayar_pokok}}" required>
                            </div>

                            <div class="form-group has-warning"><label >Nominal</label>
                            <input type="number" class="form-control" name="nominal_pokok" value="{{$sw->nominal_pokok}}" readonly>
                            </div>
                            <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Apa Anda Yakin Akan Memperbarui Data?')">Save</button>
                                        ...
                                        <td> <center>
                            <a href="simpanan_pokok/hapus/{{$sw->ID_simpanan_pokok}}"  type="button " class="btn btn-outline-danger" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none">
                            Hapus</i></a></center>
                            </td>
                            </tr>
                                                @endforeach
