...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <title>KUSPOSINDO | Jasa Usaha History</title>
  </head>
  <body id="page-top">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="jasa_history" style="color: black;"><button class="dropdown-item active" type="button" style="background-color:#e67e22">Jasa Usaha</button></a>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                                <h1 class="mt-4 container " style="text-align:left">Jasa Usaha History</h1>
                                    <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>
                               
                               <div class="container text-container anggota">
                                    <button class="initombol">
                                        <a href="{{route('jasa_history_cetak')}}" target="_blank" rel="noopener" target="_blank" style="color: black;"><i class="fas fa-print"></i> Cetak History</a>
                                    </button>
                               </div>
<br>
                            <!-- tabel  -->
