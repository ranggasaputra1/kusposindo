 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="simpanan_sukarela" style="color: black;"><button class="dropdown-item " type="button" >Sukarela</button></a>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="kredit">Kredit</a>
        </li>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                                <h1 class="mt-4 container " style="text-align:left">KUSPOSINDO | Kredit</h1>
                                    <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>
                                <div class="container text-container anggota"><a href="#"><button class="initombol " data-toggle="modal" data-target="#exampleModalLong">Tambah</button></a></div>
                                <!-- Modal -->
                  <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Data Kredit</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                        </div>
                        <div class="modal-body">
                <form method="post" action="kredit/add">
                {{ csrf_field() }}
                <div class="form-group has-warning"><label >ID kredit</label>
                    <input type="number" class="form-control" name="ID_kredit" placeholder="Sudah Diisi Otomatis" readonly>
                    </div>
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" id="search_anggota" name="ID_anggota" data-width="100%">
                    ...
                    <div class="form-group has-warning"><label >Nama barang</label>
                    <input type="text" class="form-control" name="nama_barang_kredit" required>
                    </div>

                    <div class="form-group has-warning"><label >Tanggal</label>
                    <input type="date" class="form-control" name="tanggal_kredit" required>
                    </div>

                    <div class="form-group has-warning"><label >Jangka waktu</label>
                    <select class="form-control select2 select2-hidden-accesible" id="jangka_waktu_kredit" name="jangka_waktu_kredit" required>
                      <option></option>
                      ...
                      <option value="7 Bulan">7Bulan</option>
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
     ...
     @endif
                            <!-- tabel  -->
                                    ...
                                    <tbody>
                                    @foreach($kreditt as $kredit)<tr style="text-transform: uppercase">
                                        ...
                                        <td> <center>
                                        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#ubahkredit{{$kredit->ID_kredit}}">
                                       Edit</button></center>
                                        <div class="modal fade" id="ubahkredit{{$kredit->ID_kredit}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                            <div class="modal-header">
                                            <h4 class="modal-title">Edit Data Anggota Kredit</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body" style="text-align: left">
                                  <form method="post" action="kredit/update">
                                  @csrf
                                  <div class="form-group has-warning"><label >ID kredit</label>
                    <input type="number" class="form-control" name="ID_kredit" value="{{$kredit->ID_kredit}}" readonly>
                    </div>
                    
                    <div class="form-group has-warning"><label >Anggota</label>
                            <input type="text" class="form-control" name="ID_anggota" value="{{$kredit->ID_anggota}}" readonly>
                            </div>

                    <div class="form-group has-warning"><label >Nama barang</label>
                    <input type="text" class="form-control" name="nama_barang_kredit" value="{{$kredit->nama_barang_kredit}}" required>
                    </div>

                    <div class="form-group has-warning"><label >Tanggal</label>
                    <input type="date" class="form-control" name="tanggal_kredit" value="{{$kredit->tanggal_kredit}}" required>
                    </div>
                    ...
                    <div class="form-group has-warning"><label >Nominal</label>
                    <input type="text" class="form-control" name="nominal" value="{{$kredit->nominal}}" required>
                    </div> <br>
                    <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary" onclick="return confirm('Apa Anda Yakin Akan Memperbarui Data?')">Save</button>
                      ...
                      <td> <center>
                      <a href="kredit/hapus/{{$kredit->ID_kredit}}" type="button " class="btn btn-outline-danger" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none">
                      Hapus</i></a></center>
                    </td>
                    </tr>
                                        @endforeach
