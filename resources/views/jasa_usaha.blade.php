...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <title>KUSPOSINDO | Jasa Usaha</title>
  </head>
  <body id="page-top">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="simpanan_sukarela" style="color: black;"><button class="dropdown-item " type="button" >Sukarela</button></a>
            ...
            <li class="nav-item">
          <a class="nav-link active" href="jasausaha">Jasa Usaha</a>
        </li>
        <li class="nav-item">
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                        <h1 class=" container mt-4 " style="text-align:left">Kusposindo | Jasa Usaha</h1>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title " id="exampleModalLongTitle">Tambah Data Jasa Usaha</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                        <form method="post" action="jasa_usaha/add">
                            {{ csrf_field() }}
                        <div class="form-group has-warning"><label >ID Jasa Usaha</label>
                            <input type="number" class="form-control" name="ID_jasa_usaha" placeholder="Sudah diisi Otomatis" readonly>
                            </div>
                 ...
                 <label>Anggota</label >
                  <select class="form-control" id="search_anggota" name="ID_anggota" data-width="100%">
                      ...
                      @endforeach
                            ...
                            <input type="date" class="form-control" name="tanggal_bayar_jasa" required>
                            </div>

                            <div class="form-group has-warning"><label >Nominal</label>
                            <input type="number" class="form-control" name="nominal_jasa" required>
                            </div>  
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
     ...
     @endif
                            ...
                            <!-- tabel  -->
                               <div class="card mb-4">
                                    <div class="card-header">
                                        ...
                                        DataTable Jasa Usaha | KUSPOSINDO
                                    </div>
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                        <thead>
                                        <tr style="text-transform: uppercase">
                                                    <th style="text-align: center;">ID Jasa Usaha</th>
                                            ...
                                            <tbody>
                                            @foreach ($jasa_usahaa as $sw)
                                            <tr style="text-transform: uppercase">
                                                    <td style="text-align: center;">{{$sw->ID_jasa_usaha}}</td>
                                                    <td style="text-align: center;">{{$sw->ID_anggota}}</td>
                                                    <td style="text-align: center;">{{$sw->tanggal_bayar_jasa}}</td>
                                                    <td style="text-align: center;">{{$sw->nominal_jasa}}</td>

                                                    <td> <center> <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#ubahjasa_usaha{{$sw->ID_jasa_usaha}}">
                                Edit</button> <center>
                                <div class="modal fade" id="ubahjasa_usaha{{$sw->ID_jasa_usaha}}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">


                                        <h4 class="modal-title">Edit Data Jasa Usaha</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        </div>
                                        <div class="modal-body" style="text-align: left">
                                        <form method="post" action="jasa_usaha/update">
                                            @csrf
                                        <div class="form-group has-warning"><label >ID Jasa Usaha</label>
                            <input type="number" class="form-control" name="ID_Jasa_usaha" value="{{$sw->ID_jasa_usaha}}" readonly>
                            </div>
                            ...
                            <div class="form-group has-warning"><label >Tanggal Bayar</label>
                            <input type="date" class="form-control" name="tanggal_bayar_jasa" value="{{$sw->tanggal_bayar_jasa}}" required>
                            </div>

                            <div class="form-group has-warning"><label >Nominal</label>
                            <input type="number" class="form-control" name="nominal_jasa" value="{{$sw->nominal_jasa}}" readonly>
                            </div>
                            <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Apa Anda Yakin Akan Memperbarui Data?')">Save</button>
                                        ...
                                        <td> <center>
                                <a href="jasa_usaha/hapus/{{$sw->ID_jasa_usaha}}"  type="button " class="btn btn-outline-danger" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none">
                                Hapus</i></a></center>
                                </td>
                                </tr>
                                  @endforeach
