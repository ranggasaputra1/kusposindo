...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    <title>KUSPOSINDO | History Produk</title>
  </head>
  <body id="page-top">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a href="produk_history" style="color: black;"><button class="dropdown-item active" type="button" style="background-color:#e67e22">Produk</button></a>
...
<!-- judul  -->
                    <div class="container-fluid px-4">
                                <h1 class="mt-4 container " style="text-align:left">History Produk</h1>
                                    <p class=" container ">Koperasi Usaha bersama Pos Indonesia</p>
                               
                               <div class="container text-container anggota">
                                    <button class="initombol">
                                        <a href="{{route('produk_history_cetak')}}" target="_blank" rel="noopener" target="_blank" style="color: black;"><i class="fas fa-print"></i> Cetak History</a>
                                    </button>
                               </div>
<br>
                            <!-- tabel  -->
        ...
        <td> <center>
        <a href="produk_history/hapus/{{$produk->ID_produk}}"  type="button" class="btn btn-outline-danger" onclick="return confirm('Apa Anda Yakin Akan Menghapus Data?')" style="text-transform: none;">Hapus</i></a></center></center></td>
    </td>                                    
    </tr>
                                     @endforeach
                                    </tbody> 
